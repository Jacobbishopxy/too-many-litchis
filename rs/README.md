...
- 101. [symmetric tree](./src/bin/101_symmetric_tree.rs)
- 102. [binary tree level order traversal](./src/bin/102_binary_tree_level_order_traversal.rs)
- 103. [binary tree zigzag level order traversal](./src/bin/103_binary_tree_zigzag_level_order_traversal.rs)
- 104. [maximum depth of binary tree](./src/bin/104_maximum_depth_of_binary_tree.rs)
- 105. [construct binary tree from preorder and inorder traversal](./src/bin/105_construct_binary_tree_from_preorder_and_inorder_traversal.rs)
- 106. [construct binary tree from inorder and postorder traversal](./src/bin/106_construct_binary_tree_from_inorder_and_postorder_traversal.rs)
